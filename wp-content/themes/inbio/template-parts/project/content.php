...
$password_protected_class = '';
if (!empty($post_password)) {
    $password_protected_class = 'inbio-password-protected';
}

$projects_password_protected_info_text  = isset($rainbow_options['projects_password_protected_info_text']) ? $rainbow_options['projects_password_protected_info_text'] : 'Click to View';
$project_protected_password_info_text = rainbow_get_acf_data('project_protected_password_info_text');

if (isset($project_protected_password_info_text) && !empty($project_protected_password_info_text)) {
    $protected_info_text = $project_protected_password_info_text;
} else {
    $protected_info_text = $projects_password_protected_info_text;
}
...
<div class="<?php echo esc_attr($col_class); ?> rainbow-items mt--50 mt_md--30 mt_sm--30 <?php echo esc_attr($preview_type_class); ?> faridmiatesting">
    <?php if (empty($post_password)) { ?>
            ...
            <?php } else { ?>
                ...
                <div class="inner">
                    ...
                    <div class="content">
                        <div class="category-info">
                            ...
                            <?php if ($rainbow_options['rainbow_show_project_like']) { ?>
                                ...
                                <div class="post-like pt-like-it meta">
                                    <span> <a class="like-button" href="<?php echo esc_url($link2); ?>" data-id="<?php echo esc_attr(get_the_ID()); ?>" data-nonce="<?php echo esc_attr($nonce2); ?>">
                                            <i class="feather-heart"></i><span id="like-count-<?php echo get_the_ID() ?>" class="like-count">
                        ...
                        <h4 class="title">
                            <?php if ($modal_popup_display == 'yes' && $preview_type != 'link') { ?>
                                <a href="<?php echo esc_url($card_link); ?>" data-url="<?php echo esc_url($data_url); ?>" data-toggle="modal" data-target="#exampleModalCenter-<?php echo esc_attr($id); ?>"><?php the_title(); ?>
                ...
                <?php 
                if( $modal_popup_display == 'yes') { ?> 
                <!-- Modal Portfolio Body area Start -->
                <div class="modal fade newportfolio-modal modal-layout-<?php echo esc_attr($popup_layout) ?>" id="exampleModalCenter-<?php echo esc_attr($id); ?>" tabindex="-1" role="dialog" aria-hidden="true" data-modalwrapper="portfolio-modal">
                                            ...
                                            if (!empty($row_video_src)) { ?>
                                                <div class="portfolio-popup-thumbnail">
                                                    <div class="embed-responsive embed-responsive-<?php echo esc_attr($video_ratio); ?>">
                                                        ...
                                                        <iframe class="embed-responsive-item embed-responsive-<?php echo esc_attr($video_ratio); ?>" 
                                                        ...
                                                        <div class="d-flex flex-wrap mt--20">
                                                            <?php if ($rainbow_options['rainbow_show_project_like']) { ?>
                                                                ...
                                                                <div class="post-like pt-like-it w-100 mb--30">
                                                                    <a class="like-button rn-btn thumbs-icon rn-btn thumbs-icon w-100 text-center" href="<?php echo esc_url($link); ?>" data-id="<?php echo esc_attr(get_the_ID()); ?>" data-nonce="<?php echo esc_attr($nonce); ?>">
                                                                        <span> <?php echo esc_html($likes_text); ?> </span>
                                                                        <i class="feather-thumbs-up mr--10"></i>
                                                                        <mark id="like-count2-<?php echo get_the_ID() ?>" class="like-count badge">
                                                        ...
                                                        <div class="button-group d-flex flex-wrap mt--20">
                                                            <?php if ($rainbow_options['rainbow_show_project_like']) { ?>
                                                                ...
                                                                <div class="post-like pt-like-it">
                                                                    <a class="like-button rn-btn thumbs-icon rn-btn thumbs-icon" href="<?php echo esc_url($link); ?>" data-id="<?php echo esc_attr(get_the_ID()); ?>" data-nonce="<?php echo esc_attr($nonce); ?>" target="_blank">
                                                                        <span> <?php echo esc_html($likes_text); ?> </span>
                                                                        <i class="feather-thumbs-up mr--10"></i>
                                                                        <mark id="like-count2-<?php echo get_the_ID() ?>" class="like-count badge">
                                                                            <?php echo esc_html($likes); ?>
                ...
                <!-- End Modal Portfolio area -->
            <?php } else { ?>
                <div class="rn-portfolio-custom-<?php echo esc_attr($id); ?> <?php echo esc_attr($password_protected_class); ?> rn-custom-before-login-layout">
                    <?php
                    echo do_shortcode("[protected  post_id='" . get_the_ID() . "' thumbnail_size='" . $thumb_size . "' projects_meta_display='" . $rainbow_options['rainbow_show_project_like'] . "' like_text='" . $like_this_txt . "' button_text='" . $modal_button_txt . "' project_cat_display='" . $rainbow_options['rainbow_show_project_category'] . "' modal_popup_display='" . $modal_popup_display . "' layout_style='archive' ]");
                    ?>
                    <div class="rn-portfolio__c-info">
                        <div class="rn-portfolio__info-text"><?php echo esc_html($protected_info_text); ?></div>
                    ...
                    <div class="inner inbio-password-protected-inner-content">
                        <div class="thumbnail">
                            <button type="submit" id="portfolio-password-protected-field" class="portfolio-password-protected-field">
                        ...
                        <div class="content">
                            <div class="category-info">
                                ...
                                <div class="post-like pt-like-it meta">
                                    <span>
                                        <a class="like-button" href="javascript:void(0);" data-id="" data-nonce="94de237c2e">
                                            <i class="feather-heart"></i>
                                            <span id="like-count-66" class="like-count">**</span>
                                        </a>
                                    </span>
                                </div>
                            </div>
